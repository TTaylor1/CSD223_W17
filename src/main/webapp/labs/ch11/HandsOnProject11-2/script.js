...
function displayData(){
    if(httpRequest.readystate === 4 && httpRequest.status === 200){
        ...
        document.getElemenyById("lastTradeDT").innerHTML = stockItems[2] + ", " + stockItems[3];
        document.getElementById("change").innerHTML = stockItems[4];
        document.getElementById("range").innerHTML = (stockItems[8] * 1).toFixed(2) + " &ndash; " + 
                (stockItems[7] * 1).toFixed(2);
